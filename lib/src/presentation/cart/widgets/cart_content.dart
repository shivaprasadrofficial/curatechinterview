...
import 'package:cura_tech/src/presentation/cart/widgets/cart_content_item.dart';
...
class CartContent extends StatelessWidget {
  ...
  Widget _renderCartContent(BuildContext context, LoadedCartState state) {
    final totalPrice = () => Column(children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Text(state.totalPrice, style: Theme.of(context).textTheme.title)
            ],
          )
        ]);
    ...
    final content = state.items.isNotEmpty ? cartItems() : emptyCartItems();
